...
# Make conditional imports
from motor import motor_asyncio, MotorCommandCursor
from pymongo import results, UpdateOne, DeleteOne
...
class MongoDBAtlasVectorSearchMemoryStore(MemoryStoreBase):
    ...
    async def delete_collection_async(self, collection_name: str) -> None:
        ...
        Returns:
            None
        """
        await self.database[collection_name].drop_indexes()
    ...
    async def remove_batch_async(self, collection_name: str, keys: List[str]) -> None:
        ...
        await self.database[collection_name].bulk_write(deletes, ordered=False)
